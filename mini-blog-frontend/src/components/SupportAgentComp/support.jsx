  ...
  const suggestionCards = [
    {
      ...
      id: "summarize",
      title: "Create Blog",
      desc: "How do I create a blog post?",
    },
    {
      icon: PenTool,
      id: "creative",
      title: "Edit Blog",
      desc: "Who can edit a blog and how?",
    },
    {
      icon: MessageSquare,
      id: "answer",
      title: "user Sign Up",
      desc: "How do I sign up?",
    },
  ];
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      if (!res) {
        ...
        assistantText =
          typeof res.reply === "string" ? res.reply : JSON.stringify(res.reply);
      } else if (res.message) {
      ...
      const errMsg =
        err?.message || (err?.error && String(err.error)) || "AI query failed";
                ...
                <form onSubmit={handleSendMessage} className="relative">
                  ...
                  <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        type="button"
                        className="hidden sm:block p-2 text-gray-400 hover:text-emerald-700 transition"
                      >
                      ...
                      <button
                        type="button"
                        className="p-2 text-gray-400 hover:text-emerald-700 transition"
                      >
              ...
              <div className="max-w-3xl mx-auto w-full bg-white rounded-3xl shadow-[0_0_50px_-10px_rgba(0,0,0,0.1)] border border-gray-200 p-2 relative group focus-within:border-emerald-300 transition-all">
                <form onSubmit={handleSendMessage} className="flex flex-col">
                  <div className="flex gap-2 px-2 pb-2">
                    <div className="px-3 py-1 bg-gray-50 rounded-full text-[10px] text-slate-500 font-medium cursor-pointer hover:bg-emerald-50 hover:text-emerald-700">
                      Create in-depth analysis
                    </div>
                    <div className="px-3 py-1 bg-gray-50 rounded-full text-[10px] text-slate-500 font-medium cursor-pointer hover:bg-emerald-50 hover:text-emerald-700">
                      Identify actionable tasks
